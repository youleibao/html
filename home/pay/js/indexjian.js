$(function() {
	...
	var isPoint = false;
	var val = "";
	var limitedMoney = 9999999999;
	var keyboard = $(".num1,.num2,.num3,.num4,.num5,.num6,.num7,.num8,.num9,.num0,.del,.point");
	var amount = "";
	var balance = "";
	var grain = "";
    var StatusUrl = "http://yantao.52expo.top/home/payz/Status.html?PayId=";
...
//			ipt.html("￥0.00");
			...
			$(".right").css("background", "#c3c3c3");
			rice.text("您可以获得0米");
		} else {
			var iptInt = parseInt(value);
			$(".right").css("background", "#41D60F");
...
//				var token = getQueryString("key");
	var token = "ZWU4Zjc2YzA0NDc4NDllODg5N2QxMjZiM2VhODIyYmM%3d.Fh8WKU7CUAtEY%2fcK0%2fIaSb59m4eRJykgQXdkTEUDLQBud08oFfqxa9elVHJUZ8n%2bLqZZ%2bhkAc9m6H2L9oKyzy80eJaszMU7x8JMxacSaeHw%3d.370E842148BB9795C3566AE682620F98D9CEB323FBA658A92F81B43F4B42AAD9DEFC4DA935DA78BE21A0F2B79C625F8559CA3302D6E10A78A043993CD80454A6"
//				var QrNum = getQueryString("qr");
	var QrNum = '4ffe2752-24aa-4152-beda-12214ceae245';
