...
//	load()
	...
	var balance = "";
	var grain = "";
    var StatusUrl = URL+"/home/payz/Status.html?PayId=";
...
//			ipt.html("￥0.00");
			...
			if(iptInt < limitedMoney || value == limitedMoney) {
				...
				var GiveRice = (Math.round(value * rate) / 100).toFixed(2);
				if((GiveRice * 1) < 0.01) {
